...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('products', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('working_area_bit_id')->index()->nullable();
            $table->foreign('working_area_bit_id')->references('id')->on('attribute_values')->cascadeOnDelete();
            ...
            $table->unsignedBigInteger('maxWorking_speed_id')->index()->nullable();
            $table->foreign('maxWorking_speed_id')->references('id')->on('attribute_values')->cascadeOnDelete();
            $table->unsignedBigInteger('maxTraveling_speed_id')->index()->nullable();
            $table->foreign('maxTraveling_speed_id')->references('id')->on('attribute_values')->cascadeOnDelete();
