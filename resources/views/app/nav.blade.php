<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4 rounded-2 px-6 text-center" aria-label="navbar">
    <div class="col-3 col-sm-1-5">
        <a class="navbar-brand" href="{{ route('home') }}">
            <x-logo/>
        </a>
    </div>
    <form class="d-flex ms-auto me-4 order-md-2 col-3" role="search" action="{{route('filter')}}">
    ...
    <div class="collapse navbar-collapse order-1 col-3 text-primary" id="navbars">
        ...
        @else
            <div class="col-9 row align-items-center mx-auto">
                <ul class="navbar-nav ms-3 mb-2 mb-lg-0  row justify-content-center px-4 px-md-5">
                    ...
                    <li class="nav-item col">
                        <a class="nav-link fw-semibold" href="{{route('products', 0)}}">Products</a>
                    </li>
                    <li class="nav-item col">
