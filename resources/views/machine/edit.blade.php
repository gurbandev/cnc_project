                    ...
                    <select class="form-select @error('weight_id') is-invalid @enderror" name="weight_id" id="weight_id"
                        ...
                        @foreach($attributes as $attribute)
                            @if($attribute->attribute_id == 6)
                                <option value="{{ $attribute->id }}" {{$obj->weight_id == $attribute->id ? 'selected' : ''}}>{{ $attribute->name }}</option>
                            @endif
                        @endforeach
                    </select>
                    @error('weight_id')
                    ...
                    <select class="form-select @error('working_area_id') is-invalid @enderror" name="working_area_id"
                        ...
                        @foreach($attributes as $attribute)
                            @if($attribute->attribute_id == 2)
                                <option value="{{ $attribute->id }}" {{$obj->working_area_id == $attribute->id ? 'selected' : ''}}>{{ $attribute->name }}</option>
                            @endif
                        @endforeach
                    </select>
                    ...
                    <select class="form-select @error('maxWorking_speed_id') is-invalid @enderror"
                        ...
                        @foreach($attributes as $attribute)
                            @if($attribute->attribute_id == 7)
                                <option value="{{ $attribute->id }}" {{$obj->maxWorking_speed_id == $attribute->id ? 'selected' : ''}}>{{ $attribute->name }}</option>
                            @endif
                        @endforeach
                    </select>
                    ...
                    <select class="form-select @error('maxTraveling_speed_id') is-invalid @enderror"
                        ...
                        @foreach($attributes as $attribute)
                            @if($attribute->attribute_id == 8)
                                <option value="{{ $attribute->id }}" {{$obj->maxTraveling_speed_id == $attribute->id ? 'selected' : ''}}>{{ $attribute->name }}</option>
                            @endif
                        @endforeach
                    </select>
