...
@section('content')
        ...
        {{--<h1>Hakkymyzda</h1>--}}
        {{--<h4>Biziň dükanymyzdan häzirki wagtda mebel dünýäsinde giňişleýin ulanylýan СNC maşynlaryny hem-de onuň esasy şaýlaryny we pyçaklaryny iň amatly bahadan alyp bilersiňiz!--}}
            {{--<br>--}}
            {{--<br>--}}
            {{--Hormatly dostlar! Dükanymyzyň harytlaryny biziň täze saýtymyzda www.tkmcnc.com görüp bilersiňiz!--}}
            {{--<br>--}}
            {{--<br>--}}
            {{--Şeýle hem saýtymyzda görkezilen stanoklardan başgada stanoklary biz bilen habarlaşyp sargyt edip bilersiňiz.</h4>--}}
